...
class Router implements RegistrarContract
{
    ...
    public function auth()
    {
		...
		// Authentication Routes for client
        $this->post('client/login', 'Auth\LoginController@login');
        $this->post('client/logout', 'Auth\LoginController@logout')->name('logout');

        // Registration Routes for client
        $this->post('client/register', 'Auth\RegisterController@register');

        // Password Reset Routes for client
        $this->get('client/password/reset', 'Auth\ForgotPasswordController@showLinkRequestFormForClient');
        $this->get('client/password/reset/{token}', 'Auth\ResetPasswordController@showResetFormForClient');
    }
